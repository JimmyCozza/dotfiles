...
ARCH_LIST="ripgrep docker docker-compose cmake unzip ninja tree-sitter curl fish python-pip ruby lazygit direnv wezterm pipewire pipewire-audio pipewire-alsa brightnessctl thunar thunar-volman gvfs libinput wayland wlroots libxkbcommon wayland-protocols pkgconf bemenu bemenu-wayland firefox bluez bluez-utils blueman-manager noto-fonts-emoji noto-fonts-cjk"
