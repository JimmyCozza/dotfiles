...
awesome.connect_signal("bling::playerctl::title_artist_album", function(title, artist, _)
  title_widget:set_markup_silently('<span foreground="' .. beautiful.xforeground .. '"><b>' .. title .. "</b></span>")
  artist_widget:set_markup_silently('<span foreground="' .. beautiful.xforeground .. '"><i>' .. artist .. "</i></span>")
end)
...
local playerctl_prev_symbol = create_button("", beautiful.xcolor4, prev_command, false)
local playerctl_next_symbol = create_button("", beautiful.xcolor4, next_command, false)
