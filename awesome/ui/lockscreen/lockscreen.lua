...
pass_textbox:connect_signal("widget::redraw_needed", function()
  ...
  if #pass_textbox.text > 1 then
    ...
    secret_textbox.markup = "<span foreground='" .. beautiful.xforeground .. 55 .. "'><b><i>Password</i></b></span>"
  end
end)
...
awful.screen.connect_for_each_screen(function(s)
  if s == screen.primary then
    ...
    s.mylockscreen = helpers.screen_mask(s, gradient or beautiful.exit_screen_bg or beautiful.xbackground .. "80")
  end
end)
