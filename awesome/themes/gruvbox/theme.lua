...
local theme_path = "/home/jimmy/.config/awesome/themes/gruvbox"
...
-- Hotkeys popup
theme.hotkeys_bg = theme.bg0
theme.hotkeys_fg = theme.lightgreen
...
theme.hotkeys_font = 'Hack Nerd Font Regular 9'
theme.hotkeys_description_font = 'Hack Nerd Font Regular 9'
