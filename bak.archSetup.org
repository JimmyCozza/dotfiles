...
# Pre-reqs
ARCH_LIST="alacritty fzf ripgrep tmux firefox bat discord docker docker-compose rofi flameshot aws-cli nginx python2 base-devel cmake unzip ninja tree-sitter curl zsh python-pip ruby lazygit"
